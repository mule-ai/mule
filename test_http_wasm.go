...
func main() {
	...
	wasmData, err := os.ReadFile("examples/wasm/http_methods_demo.wasm")
	if err != nil {
	...
	_, err = db.ExecContext(ctx, `
		...
		moduleID, "HTTP Test Module", "Test module for HTTP requests", wasmData)
	if err != nil {
	...
	// Print the result
	fmt.Printf("WASM Execution Result: %+v\n", result)
}