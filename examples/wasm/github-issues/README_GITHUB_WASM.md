...
echo ""
echo "Note: When fetching comments, comments with empty bodies are automatically filtered out."
echo "This helps skip deleted or invalid comments that may have empty content."
echo ""
...
echo "          {"
echo "            \"id\": 123456789,"
echo "            \"node_id\": \"MDU6TGFiZWwxMjM0NTY3ODk=\","
echo "            \"url\": \"https://api.github.com/repos/owner/repo/labels/bug\","
echo "            \"name\": \"bug\","
echo "            \"description\": \"Something isn't working\","
echo "            \"color\": \"e11d21\","
echo "            \"default\": true"
echo "          }"
echo "        ],"
